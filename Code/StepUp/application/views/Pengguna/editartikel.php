...
<head>
    <meta charset="utf-8">
    <title>Step Up | Edit Artikel</title>
...
<body style="background-image: url('<?php echo base_url('assets/img/bg.png')?>');background-size:  cover;
    ...
    <section id="buat-artikel" style="padding-top: 100px">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form autocomplete="off" id="buatsertifbaru" name="buatsertifbaru" method="post" enctype="multipart/form-data" action="<?php echo site_url('C_User/editArtikel/'.$artikel->id_artikel);?>">
                        <b>
                            <p id="gambar-text">Judul Artikel</p>
                            <hr align="left" style="margin-top: 0px;width:130px">
                        </b>
                        <input type="text" name="judul_artikel" class="form-control" value="<?php echo $artikel->judul_artikel ?>" id="judul_artikel" required="">
                        <b>
                            <p id="gambar-text">Isi Artikel</p>
                            <hr align="left" style="margin-top: 0px;width:130px">
                        </b>
                        <textarea class="ckeditor" id="ckedtor" name="artikel" required><?php echo $artikel->artikel ?></textarea>
                        <b>
                            <p id="gambar-text">Pilih Gambar Artikel</p>
                            <hr align="left" style="margin-top: 0px;width:130px">
                        </b>
                        <input class="form-control" accept="image/*" type="file" name="artikel-img" id="artikel-img">
